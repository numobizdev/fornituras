...
/**
 * Consulta de la bitácora de auditoría (012). Solo lectura, <b>restringida a administración</b>
 * (auditoría): un rol operativo que intente consultar queda denegado (y ese intento se audita, FR-006).
 * No existe endpoint de escritura: la bitácora se alimenta internamente vía el puerto {@code AuditWriter}.
 */
@RestController
...
public class AuditLogController {
	...
	@GetMapping
	@Operation(summary = "Consultar bitácora", description = "Eventos de auditoría paginados y filtrables (actor, acción, entidad, rango de fechas). Solo ADMIN.")
